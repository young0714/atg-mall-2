...
const points = [
  ...
  { title: "Backed by Apex Terra Global", desc: "ATG Mall is operated by Apex Terra Global Limited, a logistics and sourcing company with roots in Nigeria and Gambia now serving customers worldwide.", icon: "🏢" },
];
